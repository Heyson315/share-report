...
param azureAdAuthorityHost string = environment().authentication.loginEndpoint
...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    virtualNetworkSubnetId: useVnet && vnet != null ? vnet.outputs.appSubnetID : ''
...
module storage './core/storage/storage-account.bicep' = {
  ...
  params: {
    ...
    networkAcls: useVnet ? {
      ...
      virtualNetworkRules: [
        {
          id: useVnet && vnet != null ? vnet.outputs.appSubnetID : ''
          action: 'Allow'
        }
      ]
    } : {
